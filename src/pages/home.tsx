...
export default function ClientRevenueApp() {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case 'overview':
        return (
          <main className="flex-1 p-8 bg-gray-50 min-h-screen lg:ml-56">
            {/* Header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <p className="text-2xl font-bold text-gray-900">{monthClients.length}</p>
              </div>
            </div>

            {/* Analytics Overview and Recent Activities */}
            <div className="flex flex-col lg:flex-row gap-6 mb-8">
              <div className="lg:flex-1 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="font-medium text-blue-900">Add Income</p>
                    <p className="text-sm text-blue-600">Record new income</p>
                  </div>
                </button>
                <button
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-sm text-green-600">See reports & insights</p>
                  </div>
                </button>
                <button
                  className="p-4 bg-purple-50 hover:bg-purple-100 rounded-lg border border-blue-200 transition-colors"
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="font-medium text-purple-900">Manage Clients</p>
                    <p className="text-sm text-purple-600">View & edit clients</p>
                  </div>
                </button>
              </div>
            </div>
